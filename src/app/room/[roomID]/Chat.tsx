  ...
  return (
    <div className="flex h-full w-full flex-col rounded-sm border border-solid border-frame">
      ...
      <div className="flex w-full items-center justify-between border-t border-solid border-frame">
        ...
        <button
          onClick={sendMessage}
          className="flex size-10 items-center justify-center border-l border-solid border-frame transition-colors hover:bg-light-frame hover:text-dark-base-color"
        >
